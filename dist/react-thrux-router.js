...
var arrayMap = __webpack_require__(42),
    ...
    baseUnset = __webpack_require__(70),
    castPath = __webpack_require__(15),
    copyObject = __webpack_require__(8),
    customOmitClone = __webpack_require__(170),
    flatRest = __webpack_require__(77),
    getAllKeysIn = __webpack_require__(80);
...
var flatten = __webpack_require__(216),
...
var basePick = __webpack_require__(145),
    flatRest = __webpack_require__(77);
...
var _remove2 = __webpack_require__(222);

var _remove3 = _interopRequireDefault(_remove2);

var _cloneDeep = __webpack_require__(92);

var _cloneDeep2 = _interopRequireDefault(_cloneDeep);

var _get2 = __webpack_require__(94);

var _get3 = _interopRequireDefault(_get2);

var _set2 = __webpack_require__(223);

var _set3 = _interopRequireDefault(_set2);

var _keys2 = __webpack_require__(6);

var _keys3 = _interopRequireDefault(_keys2);

var _map2 = __webpack_require__(98);
...
var _assign2 = __webpack_require__(52);

var _assign3 = _interopRequireDefault(_assign2);

var _isEqual2 = __webpack_require__(96);
...
var _forEach2 = __webpack_require__(93);
...
exports.goHash = exports.closeModal = exports.openModal = exports.goRoute = exports.setTab = exports.initRoutes = undefined;
...
var _merge2 = __webpack_require__(220);

var _merge3 = _interopRequireDefault(_merge2);

var _omit2 = __webpack_require__(60);
...
var _find2 = __webpack_require__(214);

var _find3 = _interopRequireDefault(_find2);

var _urlPattern = __webpack_require__(250);

var _urlPattern2 = _interopRequireDefault(_urlPattern);

var _qs = __webpack_require__(233);

var _thrux = __webpack_require__(110);
...
var initRoutes = exports.initRoutes = function initRoutes(routes, opts) {
  options = (0, _assign3.default)({}, options, opts);
  (0, _thrux.register)({
    router: {
      INIT: (0, _thrux.createDict)(function () {
        return {
          routes: (0, _map3.default)(routes, function (route) {
            return (0, _assign3.default)({}, route, { pattern: new _urlPattern2.default(route.path) });
          })
        };
      }),
      GO_ROUTE: (0, _thrux.createDict)(function (_ref, state) {
        ...
        console.log((0, _find3.default)(state.routes, function (route) {
          return route.pattern.match(routeId || '/');
        }));
        var routeKey = routeId || '/';
        var currentRoute = (0, _find3.default)(state.routes, function (route) {
          var params = route.pattern.match(routeKey);
          if (params) {
            (0, _assign3.default)(props, params);
            return true;
          }
          return false;
        });
      ...
      SET_TAB: (0, _thrux.createDict)(function (tab, state) {
        return (0, _merge3.default)({}, state, { current: { tab: tab } });
      }),
...
var openModal = exports.openModal = function openModal(modal) {
  return (0, _thrux.dispatch)('router:OPEN_MODAL', modal);
};
...
var goHash = exports.goHash = function goHash() {
...
var _pick2 = __webpack_require__(99);
...
var _reactThrux = __webpack_require__(113);
...
var Router = function (_Component) {
  ...
  function Router(props) {
    ...
    (0, _actions.initRoutes)(props.routes, props.options);
    return _this;
  }
...
Router.propTypes = {
  routes: _propTypes2.default.oneOfType([_propTypes2.default.arrayOf(_propTypes2.default.shape({})), _propTypes2.default.shape({})]),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentDidMount = function () {
    window.onhashchange = function () {
      return (0, _actions.goHash)();
    };
    setTimeout(_actions.goHash, 0);
  };

  this.setScene = function (component) {
    _this2.scene = component;
  };
  ...
  this.renderLoading = function () {
    return _react2.default.createElement(
      'div',
      { ref: _this2.setLoading, style: _styles.fullScreen },
      _this2.props.loading || 'Loading'
    );
  };
  ...
  this.renderComponent = function () {
    var _props$router$current = _this2.props.router.current,
        ReactComponent = _props$router$current.component,
        props = _props$router$current.props;
    var modal = _this2.props.router.modal;

    return ReactComponent ? _react2.default.createElement(
      'div',
      (0, _omit3.default)(_this2.props, ['routes', 'loading', 'options', 'router']),
      _react2.default.createElement(ReactComponent, _extends({ ref: _this2.setScene }, props)),
      modal && _react2.default.createElement(_Modal2.default, modal)
    ) : _this2.renderError();
  };

  this.render = function () {
    return _this2.props.router ? _this2.renderComponent() : _this2.renderLoading();
  };
};
...
var Stack = __webpack_require__(22),
    ...
    baseMergeDeep = __webpack_require__(144),
    isObject = __webpack_require__(3),
    keysIn = __webpack_require__(34);
...
var assignMergeValue = __webpack_require__(65),
    cloneBuffer = __webpack_require__(71),
...
var basePickBy = __webpack_require__(146),
    hasIn = __webpack_require__(95);
...
var baseGet = __webpack_require__(25),
    baseSet = __webpack_require__(69),
    castPath = __webpack_require__(15);
...
var baseUnset = __webpack_require__(70),
    isIndex = __webpack_require__(18);
...
var getAllKeys = __webpack_require__(79);
...
var baseGet = __webpack_require__(25),
    baseSlice = __webpack_require__(153);
...
var createFind = __webpack_require__(169),
    findIndex = __webpack_require__(215);
...
(function(root, factory) {
  if (('function' === "function") && (__webpack_require__(251) != null)) {
